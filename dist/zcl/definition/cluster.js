            ...
            */
            respSwitchStatus: {
                ...
                parameters: [
                    ...
                    { name: 'powerStatus', type: dataType_1.default.uint8 },
                    //on/off
                    { name: 'switchState', type: dataType_1.default.uint8 }
                ]
            }
        }
    },
    alertmePowerUsage: {
        ...
        commandsResponse: {
            ...
            powerMeterUpdate: {
                ID: 0x86,
                parameters: [
                    { name: 'powerMeterUnknown', type: buffaloZclDataType_1.default.BUFFER }
                ]
            },
        }
    },
    alertmeDeviceGeneral: {
        ...
        commands: {
            setRTC: {
                ID: 0x00,
                parameters: [
                    { name: "year", type: dataType_1.default.uint16 },
                    { name: "month", type: dataType_1.default.uint8 },
                    { name: "dayOfMonth", type: dataType_1.default.uint8 },
                    { name: "dayOfWeek", type: dataType_1.default.uint8 },
                    { name: "hours", type: dataType_1.default.uint8 },
                    { name: "minutes", type: dataType_1.default.uint8 },
                    { name: "seconds", type: dataType_1.default.uint8 },
                    { name: "timezone", type: dataType_1.default.int8 },
                    { name: "daylightSaving", type: dataType_1.default.int8 },
                ]
            },
            getRTC: {
                ID: 0x80,
        ...
        commandsResponse: {
            FaultReport: {
                ID: 0x01,
                parameters: [
                    { name: 'manufId', type: dataType_1.default.uint16 },
                    { name: 'modelId', type: dataType_1.default.uint16 },
                    { name: 'faultId', type: dataType_1.default.uint16 },
                ]
            },
            GeneralCommand: {
                ID: 0x02,
                parameters: [
                    { name: 'command', type: dataType_1.default.charStr }
                ]
            },
            /*
            ...
            */
            recvHeartbeat: {
                ...
                parameters: [
                    ...
                    { name: 'lqi', type: dataType_1.default.uint8 },
                    { name: 'switchMask', type: dataType_1.default.uint8 },
                    { name: 'switchState', type: dataType_1.default.uint8 }
                ]
            },
            getRTC: {
            ...
            stdOut: {
                ID: 0x82,
                parameters: [
                    { name: "msg", type: dataType_1.default.charStr }
                ]
            }
        }
    },
    ...
    alertmeJoin: {
        ...
        commandsResponse: {
            ...
            respHello: {
                ID: 0xFE,
                parameters: [
                    { name: 'nodeId', type: dataType_1.default.uint16 },
                    { name: 'eui64', type: dataType_1.default.uint64 },
                    { name: 'mfgId', type: dataType_1.default.uint16 },
                    { name: 'deviceType', type: dataType_1.default.uint16 },
                    { name: 'appRelease', type: dataType_1.default.uint8 },
                    { name: 'appVersion', type: dataType_1.default.uint8 },
                    { name: 'hwMinorVersion', type: dataType_1.default.uint8 },
                    { name: 'hwMajorVersion', type: dataType_1.default.uint8 },
                    { name: 'mfg', type: dataType_1.default.charStr },
                    { name: 'model', type: dataType_1.default.charStr },
                    { name: 'dateCode', type: dataType_1.default.charStr }
                ]
            }
        }
    },
    ...
    alertmeUpgrade: {
        ...
        commands: {
            do: {
                ID: 0x00,
                parameters: [
                    { name: 'id1', type: dataType_1.default.uint32 },
                    { name: 'id2', type: dataType_1.default.uint32 }
                ]
            }
        },
        commandsResponse: {
            ...
            do2: {
                ID: 0x04,
                parameters: [
                    { name: 'status', type: dataType_1.default.uint64 },
                    { name: 'app_release', type: dataType_1.default.uint8 },
                    { name: 'app_version', type: dataType_1.default.uint8 }
                ]
            }
        }
    },
